...
/**
 * @typedef IBlendShaderParts   object
 *
 * @property {string} [uniformCode]     (optional) Code that declares any additional uniforms
 *    to be accepted by the {@link BlendFilter}. If you do use this, make sure these uniforms
 *    are passed in {@link IBlendShaderParts.uniforms uniforms}.
 *
 * @property {object[string: *]} [uniforms]   (optional) Uniforms to pass to the resulting {@link BlendFilter}.
 *
...
{
  /**
   * @param {IBlendShaderParts} shaderParts - The blending code shader part.
   */
