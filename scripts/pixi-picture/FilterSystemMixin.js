...
/**
 * @param {PIXI.Rectangle} rectOut
 * @param {PIXI.Rectangle} rectIn
 * @returns {boolean}
 */
...
/**
 * @this {IPictureFilterSystem}
 * @param {DisplayObject} target
 * @param {Array<BackdropFilter>} filters
 * @param {boolean} [checkEmptyBounds=true]
 */
...
function pop()
{
  ...
  const filters = state.filters; // Array<BackdropFilter>
...
function prepareBackdrop(bounds, flipY)
{
  ...
  const tf = renderer.projection.transform || PIXI.Matrix.IDENTITY;
...
{
  PIXI.TextureSystem.prototype.bindForceLocation = bindForceLocation;
  PIXI.FilterSystem.prototype.push = push;
  PIXI.FilterSystem.prototype.pushWithCheck = pushWithCheck;
  PIXI.FilterSystem.prototype.pop = pop;
  PIXI.FilterSystem.prototype.prepareBackdrop = prepareBackdrop;
}
