 ...
 * code.
 *
 * @type {Array<IBlendModeShaderParts>}
 */
export const blendPartsArray = [];

blendPartsArray[PIXI.BLEND_MODES.MULTIPLY] = MULTIPLY_PART;
blendPartsArray[PIXI.BLEND_MODES.OVERLAY] = OVERLAY_PART;
blendPartsArray[PIXI.BLEND_MODES.HARD_LIGHT] = HARDLIGHT_PART;
blendPartsArray[PIXI.BLEND_MODES.SOFT_LIGHT] = SOFTLIGHT_PART;
blendPartsArray[PIXI.BLEND_MODES.DARKEN] = DARKEN_PART;
blendPartsArray[PIXI.BLEND_MODES.LIGHTEN] = LIGHTEN_PART;
blendPartsArray[PIXI.BLEND_MODES.COLOR_DODGE] = COLOR_DODGE_PART;
blendPartsArray[PIXI.BLEND_MODES.COLOR_BURN] = COLOR_BURN_PART;
...
/** @type {Array<BlendFilter>} */
const filterCache = [];

/** @type {Array<Array<BlendFilter>>} */
const filterCacheArray = [];

/** @type {Array<boolean>} */
const trivialBlend = new Array(32);

trivialBlend[PIXI.BLEND_MODES.NORMAL] = true;
trivialBlend[PIXI.BLEND_MODES.ADD] = true;
trivialBlend[PIXI.BLEND_MODES.SCREEN] = true;
trivialBlend[PIXI.BLEND_MODES.DST_OUT] = true;
trivialBlend[PIXI.BLEND_MODES.DST_IN] = true;
trivialBlend[PIXI.BLEND_MODES.DST_OVER] = true;
trivialBlend[PIXI.BLEND_MODES.DST_ATOP] = true;
trivialBlend[PIXI.BLEND_MODES.SRC_OUT] = true;
trivialBlend[PIXI.BLEND_MODES.SRC_IN] = true;
trivialBlend[PIXI.BLEND_MODES.SRC_OVER] = true;
trivialBlend[PIXI.BLEND_MODES.SRC_ATOP] = true;
trivialBlend[PIXI.BLEND_MODES.SRC_OUT] = true;
trivialBlend[PIXI.BLEND_MODES.SRC_IN] = true;
trivialBlend[PIXI.BLEND_MODES.SRC_OVER] = true;
trivialBlend[PIXI.BLEND_MODES.XOR] = true;
trivialBlend[PIXI.BLEND_MODES.SUBTRACT] = true;
 ...
 * due to memoization!
 *
 * @param {PIXI.BLEND_MODES} blendMode - The blend mode desired.
 */
export function getBlendFilter(blendMode)
{
  ...
  if (!filterCache[blendMode])
  {
    if (triv)
    {
      filterCache[blendMode] = new PIXI.Filter();
 ...
 * @param {PIXI.BLEND_MODES} blendMode - The blend mode desired.
 */
export function getBlendFilterArray(blendMode)
{
